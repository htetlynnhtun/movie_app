...
class _$_NoConnection<T> extends _NoConnection<T> {
  ...
  @override
  String toString() {
    return 'ApiResponse<$T>.noConnection()';
  }
...
abstract class _NoConnection<T> extends ApiResponse<T> {
...
class _$_NotModified<T> extends _NotModified<T> {
  ...
  @override
  String toString() {
    return 'ApiResponse<$T>.notModified()';
  }
...
abstract class _NotModified<T> extends ApiResponse<T> {
...
class _$_WithNewData<T> extends _WithNewData<T> {
  ...
  @override
  String toString() {
    return 'ApiResponse<$T>.withNewData(data: $data)';
  }
...
abstract class _WithNewData<T> extends ApiResponse<T> {
